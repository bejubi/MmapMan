...
namespace MmapManager.Console.Activity {
    ...
    public partial class ProcessStep : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ProcessStep).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ProcessStep));
        ...
        private string FindResource() {
            string[] resources = typeof(ProcessStep).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ProcessStep.g.xaml") || resource.Equals("ProcessStep.g.xaml"))) {
                    return resource;
                }
            }
