...
namespace WorkflowConsoleApplication1.Samples {
    ...
    public partial class PowershellSample : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(PowershellSample).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(PowershellSample));
        ...
        private string FindResource() {
            string[] resources = typeof(PowershellSample).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".PowershellSample.g.xaml") || resource.Equals("PowershellSample.g.xaml"))) {
                    return resource;
                }
            }
