...
namespace WorkflowConsoleApplication1.ProcessMockup {
    ...
    public partial class FindScript : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(FindScript).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(FindScript));
        ...
        private string FindResource() {
            string[] resources = typeof(FindScript).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".FindScript.g.xaml") || resource.Equals("FindScript.g.xaml"))) {
                    return resource;
                }
            }
