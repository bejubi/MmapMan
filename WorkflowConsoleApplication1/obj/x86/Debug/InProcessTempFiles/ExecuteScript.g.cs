...
namespace WorkflowConsoleApplication1.ProcessMockup {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class ExecuteScript : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ExecuteScript).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ExecuteScript));
        ...
        private string FindResource() {
            string[] resources = typeof(ExecuteScript).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ExecuteScript.g.xaml") || resource.Equals("ExecuteScript.g.xaml"))) {
                    return resource;
                }
            }
