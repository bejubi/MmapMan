...
namespace WorkflowConsoleApplication1.Activity {
    ...
    public partial class ExecutePowershellSequence : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public ExecutePowershellSequence() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ExecutePowershellSequence).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ExecutePowershellSequence));
        ...
        private string FindResource() {
            string[] resources = typeof(ExecutePowershellSequence).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ExecutePowershellSequence.g.xaml") || resource.Equals("ExecutePowershellSequence.g.xaml"))) {
                    return resource;
                }
            }
