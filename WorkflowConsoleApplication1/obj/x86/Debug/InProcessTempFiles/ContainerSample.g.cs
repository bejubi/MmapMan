...
namespace WorkflowConsoleApplication1.Samples {
    ...
    public partial class ContainerSample : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ContainerSample).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ContainerSample));
        ...
        private string FindResource() {
            string[] resources = typeof(ContainerSample).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ContainerSample.g.xaml") || resource.Equals("ContainerSample.g.xaml"))) {
                    return resource;
                }
            }
