...
namespace WorkflowConsoleApplication1.Samples {
    ...
    public partial class SimpleXmlSample : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SimpleXmlSample).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SimpleXmlSample));
        ...
        private string FindResource() {
            string[] resources = typeof(SimpleXmlSample).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SimpleXmlSample - Copy.g.xaml") || resource.Equals("SimpleXmlSample - Copy.g.xaml"))) {
                    return resource;
                }
            }
