...
namespace WorkflowConsoleApplication1 {
    ...
    public partial class ProcessMockup : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ProcessMockup).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ProcessMockup));
        ...
        private string FindResource() {
            string[] resources = typeof(ProcessMockup).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ProcessMockup.g.xaml") || resource.Equals("ProcessMockup.g.xaml"))) {
                    return resource;
                }
            }
