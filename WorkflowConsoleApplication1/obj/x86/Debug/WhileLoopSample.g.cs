...
namespace WorkflowConsoleApplication1.Samples {
    ...
    public partial class WhileLoopSample : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(WhileLoopSample).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(WhileLoopSample));
        ...
        private string FindResource() {
            string[] resources = typeof(WhileLoopSample).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".WhileLoopSample.g.xaml") || resource.Equals("WhileLoopSample.g.xaml"))) {
                    return resource;
                }
            }
